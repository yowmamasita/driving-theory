    ...
    async def save_user_session(
        ...
        await self.pool.execute(
            """INSERT OR REPLACE INTO user_sessions 
               (user_telegram_id, current_question, language, question_start_time, awaiting_answer, updated_at)
               VALUES (?, ?, ?, ?, ?, ?)""",
            (user_telegram_id, current_question, language, question_start_time, awaiting_answer, datetime.now())
        )
